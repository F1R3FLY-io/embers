...
- **F1R3Sky Frontend**: See `services/f1r3sky/docs/known-issues.md` (captcha, feed error, wallet config)
- **F1R3Sky wallet**: Requires rebuilding frontend with `EXPO_PUBLIC_EMBERS_API_URL=http://localhost:8080` — the pre-built Docker image doesn't have this set
