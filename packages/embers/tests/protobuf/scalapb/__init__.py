...
class MessageOptions(betterproto2.Message):
    ...
    derives: "list[str]" = betterproto2.field(11, betterproto2.TYPE_STRING, repeated=True)
    """
    Adds a derives clause to the message case class
    """

    sealed_oneof_derives: "list[str]" = betterproto2.field(12, betterproto2.TYPE_STRING, repeated=True)
    """
    Additional classes and traits to add to the derives clause of a sealed oneof.
    """

    sealed_oneof_empty_extends: "list[str]" = betterproto2.field(13, betterproto2.TYPE_STRING, repeated=True)
    """
...
class ScalaPbOptions(betterproto2.Message):
    ...
    scala3_sources: "bool" = betterproto2.field(28, betterproto2.TYPE_BOOL)
    """
    Generate sources that are compatible with Scala 3
    """

    public_constructor_parameters: "bool" = betterproto2.field(29, betterproto2.TYPE_BOOL)
    """
