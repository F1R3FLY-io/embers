...
# sources: CasperMessage.proto, DeployServiceCommon.proto, ExternalCommunicationServiceCommon.proto, ProposeServiceCommon.proto
...
class DeployFinalizationStateProto(betterproto2.Enum):
    DEPLOY_STATE_UNSPECIFIED = 0

    DEPLOY_STATE_FINALIZED = 1

    DEPLOY_STATE_FAILED = 2

    DEPLOY_STATE_PENDING = 3

    DEPLOY_STATE_EXPIRED = 4
...
class BlockMetadataInternal(betterproto2.Message):
    ...
    fault_tolerance_value: "float" = betterproto2.field(11, betterproto2.TYPE_FLOAT)
    """
...
class DeployDataProto(betterproto2.Message):
    ...
    **TODO**: details of signatures and payment. See RHOL-781
    ...
    language: "str" = betterproto2.field(12, betterproto2.TYPE_STRING)
    """
    language (rholang or metta) of the source code
    """

    expiration_timestamp: "int" = betterproto2.field(13, betterproto2.TYPE_INT64)
    """
...
@dataclass(eq=False, repr=False)
class DeployFinalizationStatusInfo(betterproto2.Message):
    state: "DeployFinalizationStateProto" = betterproto2.field(
        1, betterproto2.TYPE_ENUM, default_factory=lambda: DeployFinalizationStateProto(0)
    )

    rejection_count: "int" = betterproto2.field(2, betterproto2.TYPE_UINT32)

    latest_block_hash: "bytes | None" = betterproto2.field(3, betterproto2.TYPE_BYTES, optional=True)
    """
...
default_message_pool.register_message("casper", "DeployFinalizationStatusInfo", DeployFinalizationStatusInfo)


@dataclass(eq=False, repr=False)
class DeployFinalizationStatusQuery(betterproto2.Message):
    deploy_sig: "bytes" = betterproto2.field(1, betterproto2.TYPE_BYTES)


default_message_pool.register_message("casper", "DeployFinalizationStatusQuery", DeployFinalizationStatusQuery)
...
class DeployInfo(betterproto2.Message):
    ...
    transfers: "list[TransferInfo]" = betterproto2.field(13, betterproto2.TYPE_MESSAGE, repeated=True)

    transfers_available: "bool" = betterproto2.field(14, betterproto2.TYPE_BOOL)
    """
...
class LightBlockInfo(betterproto2.Message):
    ...
    is_finalized: "bool" = betterproto2.field(22, betterproto2.TYPE_BOOL)
...
@dataclass(eq=False, repr=False)
class MergeableEntryRequestProto(betterproto2.Message):
    """
...
default_message_pool.register_message("casper", "MergeableEntryRequestProto", MergeableEntryRequestProto)


@dataclass(eq=False, repr=False)
class MergeableEntryResponseProto(betterproto2.Message):
    block_hash: "bytes" = betterproto2.field(1, betterproto2.TYPE_BYTES)

    serialized_entry: "bytes" = betterproto2.field(2, betterproto2.TYPE_BYTES)
    """
...
default_message_pool.register_message("casper", "MergeableEntryResponseProto", MergeableEntryResponseProto)
...
class NoApprovedBlockAvailableProto(betterproto2.Message):
    ...
    node_identifier: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
...
@dataclass(eq=False, repr=False)
class PeerInfo(betterproto2.Message):
    address: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)
    """
    Full rnode:// URL
    """

    node_id: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
    """
    Public key hash (hex)
    """
    ...
    protocol_port: "int" = betterproto2.field(4, betterproto2.TYPE_INT32)
    """
    TCP port
    """

    discovery_port: "int" = betterproto2.field(5, betterproto2.TYPE_INT32)
    """
    UDP port
    """

    is_connected: "bool" = betterproto2.field(6, betterproto2.TYPE_BOOL)
    """
    True if active connection
    """


default_message_pool.register_message("casper", "PeerInfo", PeerInfo)


@dataclass(eq=False, repr=False)
class PrintUnmatchedSendsQuery(betterproto2.Message):
    """
    TODO remove it
    """

    print_unmatched_sends: "bool" = betterproto2.field(1, betterproto2.TYPE_BOOL)


default_message_pool.register_message("casper", "PrintUnmatchedSendsQuery", PrintUnmatchedSendsQuery)
...
class ProduceEventProto(betterproto2.Message):
    ...
    is_deterministic: "bool" = betterproto2.field(5, betterproto2.TYPE_BOOL)

    output_value: "list[bytes]" = betterproto2.field(6, betterproto2.TYPE_BYTES, repeated=True)

    failed: "bool" = betterproto2.field(7, betterproto2.TYPE_BOOL)
...
@dataclass(eq=False, repr=False)
class ProposeQuery(betterproto2.Message):
    is_async: "bool" = betterproto2.field(1, betterproto2.TYPE_BOOL)


default_message_pool.register_message("casper", "ProposeQuery", ProposeQuery)


@dataclass(eq=False, repr=False)
class ProposeResultQuery(betterproto2.Message):
    pass


default_message_pool.register_message("casper", "ProposeResultQuery", ProposeResultQuery)
...
class Status(betterproto2.Message):
    ...
    peer_list: "list[PeerInfo]" = betterproto2.field(8, betterproto2.TYPE_MESSAGE, repeated=True)
    """
    Detailed peer list
    """

    native_token_name: "str" = betterproto2.field(9, betterproto2.TYPE_STRING)
    """
    ...
    native_token_symbol: "str" = betterproto2.field(10, betterproto2.TYPE_STRING)

    native_token_decimals: "int" = betterproto2.field(11, betterproto2.TYPE_UINT32)

    last_finalized_block_number: "int" = betterproto2.field(12, betterproto2.TYPE_INT64)

    is_validator: "bool" = betterproto2.field(13, betterproto2.TYPE_BOOL)

    is_read_only: "bool" = betterproto2.field(14, betterproto2.TYPE_BOOL)

    is_ready: "bool" = betterproto2.field(15, betterproto2.TYPE_BOOL)

    current_epoch: "int" = betterproto2.field(16, betterproto2.TYPE_INT64)

    epoch_length: "int" = betterproto2.field(17, betterproto2.TYPE_INT32)
...
@dataclass(eq=False, repr=False)
class TransferInfo(betterproto2.Message):
    from_addr: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)
    """
    Sender address
    """

    to_addr: "str" = betterproto2.field(2, betterproto2.TYPE_STRING)
    """
    Recipient address
    """

    amount: "int" = betterproto2.field(3, betterproto2.TYPE_INT64)
    """
    Amount in dust (smallest unit)
    """

    success: "bool" = betterproto2.field(4, betterproto2.TYPE_BOOL)
    """
    Whether the transfer succeeded
    """

    fail_reason: "str" = betterproto2.field(5, betterproto2.TYPE_STRING)
    """
    Error message if success is false, empty otherwise
    """


default_message_pool.register_message("casper", "TransferInfo", TransferInfo)
...
@dataclass(eq=False, repr=False)
class UpdateNotification(betterproto2.Message):
    client_host: "str" = betterproto2.field(1, betterproto2.TYPE_STRING)

    client_port: "int" = betterproto2.field(2, betterproto2.TYPE_INT32)

    payload: "str" = betterproto2.field(3, betterproto2.TYPE_STRING)


default_message_pool.register_message("casper", "UpdateNotification", UpdateNotification)


@dataclass(eq=False, repr=False)
class UpdateNotificationResponse(betterproto2.Message):
    pass


default_message_pool.register_message("casper", "UpdateNotificationResponse", UpdateNotificationResponse)
