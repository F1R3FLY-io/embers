...
# sources: DeployServiceV1.proto, ExternalCommunicationServiceV1.proto, ProposeServiceV1.proto
...
__all__ = (
    ...
    "ExternalCommunicationServiceStub",
    "FindDeployResponse",
    "IsFinalizedResponse",
...
@dataclass(eq=False, repr=False)
class DeployFinalizationStatusResponse(betterproto2.Message):
    """
    ...
    status: "__casper__.DeployFinalizationStatusInfo | None" = betterproto2.field(
        2, betterproto2.TYPE_MESSAGE, optional=True, group="message"
    )


default_message_pool.register_message("casper.v1", "DeployFinalizationStatusResponse", DeployFinalizationStatusResponse)
...
class ExploratoryDeployResponse(betterproto2.Message):
    ...
    cost: "int" = betterproto2.field(3, betterproto2.TYPE_UINT64)
...
@dataclass(eq=False, repr=False)
class ProposeResponse(betterproto2.Message):
    """
...
default_message_pool.register_message("casper.v1", "ProposeResponse", ProposeResponse)


@dataclass(eq=False, repr=False)
class ProposeResultResponse(betterproto2.Message):
    """
...
default_message_pool.register_message("casper.v1", "ProposeResultResponse", ProposeResultResponse)
...
default_message_pool.register_message("casper.v1", "UpdateNotificationResponse", UpdateNotificationResponse)
...
class DeployServiceStub:
    ...
    def deploy_finalization_status(
        self, message: "__casper__.DeployFinalizationStatusQuery"
    ) -> "DeployFinalizationStatusResponse":
        """
        ...
        return self._channel.unary_unary(
            ...
            __casper__.DeployFinalizationStatusQuery.SerializeToString,
            DeployFinalizationStatusResponse.FromString,
        )(message)
...
class ExternalCommunicationServiceStub:
    ...
    def send_notification(self, message: "__casper__.UpdateNotification") -> "UpdateNotificationResponse":
        return self._channel.unary_unary(
            "/casper.v1.ExternalCommunicationService/sendNotification",
            __casper__.UpdateNotification.SerializeToString,
            UpdateNotificationResponse.FromString,
        )(message)
...
class ProposeServiceStub:
    ...
    def propose(self, message: "__casper__.ProposeQuery") -> "ProposeResponse":
        return self._channel.unary_unary(
            "/casper.v1.ProposeService/propose",
            __casper__.ProposeQuery.SerializeToString,
            ProposeResponse.FromString,
        )(message)

    def propose_result(self, message: "__casper__.ProposeResultQuery | None" = None) -> "ProposeResultResponse":
        if message is None:
            message = __casper__.ProposeResultQuery()

        return self._channel.unary_unary(
            "/casper.v1.ProposeService/proposeResult",
            __casper__.ProposeResultQuery.SerializeToString,
            ProposeResultResponse.FromString,
        )(message)
